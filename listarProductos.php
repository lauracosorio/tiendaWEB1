                                    ...
                                    <form action="editarProducto.php?id=<?php echo($producto['idProducto'])?>"
                                        ...
                                        <div class="form-row justify-content-center">
                                            <div class="col-sm-6 col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control input" name="nombreProducto"
                                                    value="<?php echo($producto['nombreProducto'])?>">
                                            </div>
                                            <div class="col-sm-6 col-md-6 mb-3">
                                                <label>Marca del producto</label>
                                                <input type="text" class="form-control input" name="marcaProducto"
                                        ...
                                        <div class="form-row justify-content-center">
                                            <div class="col-sm-12 col-md-12 mb-3">
                                                ...
                                                <input type="text" class="form-control input" name="precio"
                                                    value="<?php echo($producto['precioProducto'])?>">
                                            </div>
                                        </div>
                                        <div class="form-group justify-content-center">
                                            <label>Descripción</label>
                                            <textarea class="form-control col-md-12 col-md-6 m-auto input" name="descripcion"
